...
class Gui:
    ...
    def make_items(self):
        ...
        # DEFINE FRAMES
        player_frame = LabelFrame(self.root, background="#9BECE9")
        player_frame.grid(row=1, column=0, sticky=W, ipadx=23, ipady=36, padx=(10, 3), pady=(5, 3))
        global dice_frame
        dice_frame = LabelFrame(self.root, background="#9BECE9")
        dice_frame.grid(row=2, column=0, sticky=W, ipadx=21, ipady=12, padx=(10, 3), pady=(3, 3))
        global game_frame
        game_frame = LabelFrame(self.root, background="#9BECE9")
        game_frame.grid(row=1, column=1, rowspan=2, pady=(5, 0))

        # PLAYER_FRAME
        player_lab = Label(player_frame, bg="#9BECE9", text="Players", font=("Times", "20", "bold italic"))
        ...
        player_1 = Label(player_frame, bg="#9BECE9", textvariable=label_text_1_value, font=("Times", "15", "bold italic"),
        ...
        player_2 = Label(player_frame, bg="#9BECE9", textvariable=label_text_2_value, font=("Times", "15", "bold italic"),
        ...
        player_3 = Label(player_frame, bg="#9BECE9", textvariable=label_text_3_value, font=("Times", "15", "bold italic"),
        ...
        player_4 = Label(player_frame, bg="#9BECE9", textvariable=label_text_4_value, font=("Times", "15", "bold italic"),
        ...
        self.turn_gui.set('')
        dice_lab = Label(dice_frame, bg="#9BECE9", textvariable=self.turn_gui, font=("Helvetica", "12", "bold italic"))
        dice_lab.grid(row=0, column=0, padx=(40, 0), pady=(10, 60))
        self.dice_number = IntVar()
        self.dice_number.set(0)
        dice_number = Label(dice_frame, bg="#9BECE9", textvariable=self.dice_number, font=("Helvetica", "12", "bold italic"))
        dice_number.grid(row=3, column=0, padx=(40, 0), pady=(10, 60))

        self.dice_btn = Button(dice_frame, bg="#008B8B", text='Roll Dice...', font=("Helvetica", "12", "bold italic"),
                               state='disabled',
        ...
        red_home_1 = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        red_home_1.grid(row=0, column=0, padx=(10, 10), pady=(10, 10))
        self.red_home_btn.append(red_home_1)
        red_home_2 = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        red_home_2.grid(row=0, column=1, padx=(10, 10), pady=(10, 10))
        self.red_home_btn.append(red_home_2)
        red_home_3 = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        red_home_3.grid(row=1, column=0, padx=(10, 10), pady=(10, 10))
        self.red_home_btn.append(red_home_3)
        red_home_4 = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        red_home_4.grid(row=1, column=1, padx=(10, 10), pady=(10, 10))
        self.red_home_btn.append(red_home_4)

        green_home_1 = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        green_home_1.grid(row=0, column=7, padx=(10, 10), pady=(10, 10))
        self.green_home_btn.append(green_home_1)
        green_home_2 = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        green_home_2.grid(row=0, column=8, padx=(10, 10), pady=(10, 10))
        self.green_home_btn.append(green_home_2)
        green_home_3 = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        green_home_3.grid(row=1, column=7, padx=(10, 10), pady=(10, 10))
        self.green_home_btn.append(green_home_3)
        green_home_4 = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        green_home_4.grid(row=1, column=8, padx=(10, 10), pady=(10, 10))
        self.green_home_btn.append(green_home_4)

        blue_home_1 = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        blue_home_1.grid(row=7, column=0, padx=(10, 10), pady=(10, 10))
        self.blue_home_btn.append(blue_home_1)
        blue_home_2 = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        blue_home_2.grid(row=7, column=1, padx=(10, 10), pady=(10, 10))
        self.blue_home_btn.append(blue_home_2)
        blue_home_3 = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        blue_home_3.grid(row=8, column=0, padx=(10, 10), pady=(10, 10))
        self.blue_home_btn.append(blue_home_3)
        blue_home_4 = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        blue_home_4.grid(row=8, column=1, padx=(10, 10), pady=(10, 10))
        self.blue_home_btn.append(blue_home_4)

        yellow_home_1 = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        yellow_home_1.grid(row=7, column=7, padx=(10, 10), pady=(10, 10))
        self.yellow_home_btn.append(yellow_home_1)
        yellow_home_2 = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        yellow_home_2.grid(row=7, column=8, padx=(10, 10), pady=(10, 10))
        self.yellow_home_btn.append(yellow_home_2)
        yellow_home_3 = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        yellow_home_3.grid(row=8, column=7, padx=(10, 10), pady=(10, 10))
        self.yellow_home_btn.append(yellow_home_3)
        yellow_home_4 = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0)
        yellow_home_4.grid(row=8, column=8, padx=(10, 10), pady=(10, 10))
        self.yellow_home_btn.append(yellow_home_4)

        btn_1 = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(1))
        btn_1.image = im1
        btn_1.grid(row=3, column=1, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_1)

        btn_2 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(2))
        btn_2.image = im5
        btn_2.grid(row=4, column=1, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_2)

        btn_3 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(3))
        btn_3.grid(row=5, column=1, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_3)

        btn_4 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(4))
        btn_4.grid(row=5, column=2, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_4)

        btn_5 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(5))
        btn_5.grid(row=5, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_5)

        btn_6 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(6))
        btn_6.grid(row=6, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_6)

        btn_7 = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(7))
        btn_7.image = im2
        btn_7.grid(row=7, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_7)

        btn_8 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(8))
        btn_8.grid(row=7, column=4, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_8)

        btn_9 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(9))
        btn_9.grid(row=7, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_9)

        btn_10 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(10))
        btn_10.grid(row=6, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_10)

        btn_11 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(11))
        btn_11.grid(row=5, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_11)

        btn_12 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(12))
        btn_12.grid(row=5, column=6, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_12)

        btn_13 = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(13))
        btn_13.image = im4
        btn_13.grid(row=5, column=7, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_13)

        btn_14 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(14))
        btn_14.grid(row=4, column=7, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_14)

        btn_15 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(15))
        btn_15.grid(row=3, column=7, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_15)

        btn_16 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(16))
        btn_16.grid(row=3, column=6, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_16)

        btn_17 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(17))
        btn_17.grid(row=3, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_17)

        btn_18 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(18))
        btn_18.grid(row=2, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_18)

        btn_19 = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(19))
        btn_19.image = im3
        btn_19.grid(row=1, column=5, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_19)

        btn_20 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(20))
        btn_20.grid(row=1, column=4, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_20)

        btn_21 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(21))
        btn_21.grid(row=1, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_21)

        btn_22 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(22))
        btn_22.grid(row=2, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_22)

        btn_23 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(23))
        btn_23.grid(row=3, column=3, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_23)

        btn_24 = Button(game_frame, image=im5, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.board_clicked(24))
        btn_24.grid(row=3, column=2, padx=(10, 10), pady=(10, 10))
        self.board_game_btn.append(btn_24)

        self.red_win = Button(game_frame, image=im1, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.win_clicked())
        self.red_win.grid(row=4, column=2, padx=(10, 10), pady=(10, 10))
        self.green_win = Button(game_frame, image=im3, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.win_clicked())
        self.green_win.grid(row=2, column=4, padx=(10, 10), pady=(10, 10))
        self.blue_win = Button(game_frame, image=im2, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.win_clicked())
        self.blue_win.grid(row=6, column=4, padx=(10, 10), pady=(10, 10))
        self.yellow_win = Button(game_frame, image=im4, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.win_clicked())
        self.yellow_win.grid(row=4, column=6, padx=(10, 10), pady=(10, 10))

    def add_players_gui(self):
        log_in_page = Toplevel()
        log_in_page.configure(background='Lavender')
        log_in_page.title("log in ")
        log_in_page.title("LOG IN")
        log_in_page.geometry('400x250')

        uname = Label(log_in_page, bg='Lavender', text="Username:").grid(row=0, padx=(50, 0), pady=(60, 10), sticky="W")
        passwd = Label(log_in_page, bg='Lavender', text="Password:").grid(row=1, padx=(50, 0), pady=(10, 10), sticky="W")
        color = Label(log_in_page, bg='Lavender', text="Color:").grid(row=2, padx=(50, 0), pady=(10, 10), sticky="W")
    ...
    def login_clicked(self, username, password, mycolor, page_name):
        ...
        if mycolor == 'red':
            ...
            borR = borR.resize((55, 55), Image.ANTIALIAS)
            red = ImageTk.PhotoImage(borR)
            r1 = Button(game_frame, image=red, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(1, mycolor))
            r1.image = red
            r1.grid(row=0, column=0, padx=(10, 10), pady=(10, 10))
            r2 = Button(game_frame, image=red, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(2, mycolor))
            r2.grid(row=0, column=1, padx=(10, 10), pady=(10, 10))
            r3 = Button(game_frame, image=red, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(3, mycolor))
            r3.grid(row=1, column=0, padx=(10, 10), pady=(10, 10))
            r4 = Button(game_frame, image=red, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(4, mycolor))
            r4.grid(row=1, column=1, padx=(10, 10), pady=(10, 10))
            self.piece_in_game[mycolor] = [r1, r2, r3, r4]
            self.Game.players.append(self.Bord.add_player(username, password, mycolor, ID, game_frame, [r1, r2, r3, r4]))
        elif mycolor == 'blue':
            borB = Image.open('blue.png')
            borB = borB.resize((55, 55), Image.ANTIALIAS)
            blue = ImageTk.PhotoImage(borB)
            b1 = Button(game_frame, image=blue, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(1, mycolor))
            b1.image = blue
            b1.grid(row=7, column=0, padx=(10, 10), pady=(10, 10))
            b2 = Button(game_frame, image=blue, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(2, mycolor))
            b2.grid(row=7, column=1, padx=(10, 10), pady=(10, 10))
            b3 = Button(game_frame, image=blue, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(3, mycolor))
            b3.grid(row=8, column=0, padx=(10, 10), pady=(10, 10))
            b4 = Button(game_frame, image=blue, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(4, mycolor))
            ...
            borG = borG.resize((55, 55), Image.ANTIALIAS)
            green = ImageTk.PhotoImage(borG)
            g1 = Button(game_frame, image=green, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(1, mycolor))
            g1.image = green
            g1.grid(row=0, column=7, padx=(10, 10), pady=(10, 10))
            g2 = Button(game_frame, image=green, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(2, mycolor))
            g2.grid(row=0, column=8, padx=(10, 10), pady=(10, 10))
            g3 = Button(game_frame, image=green, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(3, mycolor))
            g3.grid(row=1, column=7, padx=(10, 10), pady=(10, 10))
            g4 = Button(game_frame, image=green, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(4, mycolor))
            ...
            borY = borY.resize((55, 55), Image.ANTIALIAS)
            yellow = ImageTk.PhotoImage(borY)
            y1 = Button(game_frame, image=yellow, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(1, mycolor))
            y1.image = yellow
            y1.grid(row=7, column=7, padx=(10, 10), pady=(10, 10))
            y2 = Button(game_frame, image=yellow, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(2, mycolor))
            y2.grid(row=7, column=8, padx=(10, 10), pady=(10, 10))
            y3 = Button(game_frame, image=yellow, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(3, mycolor))
            y3.grid(row=8, column=7, padx=(10, 10), pady=(10, 10))
            y4 = Button(game_frame, image=yellow, bg="#9BECE9", padx=18, pady=10, borderwidth=0, command=lambda: self.distanation(4, mycolor))
